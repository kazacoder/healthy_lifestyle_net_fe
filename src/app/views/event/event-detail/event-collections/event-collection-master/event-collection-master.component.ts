import {AfterViewChecked, Component, CUSTOM_ELEMENTS_SCHEMA, Input, OnInit} from '@angular/core';
...
export class EventCollectionMasterComponent implements OnInit, AfterViewChecked {
  @Input() title: string = '';
  @Input() index: string = '';
